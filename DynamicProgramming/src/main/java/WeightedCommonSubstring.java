...
//        delta = -3;
        letterFrequency.put('A', 1.0);
        letterFrequency.put('B', 2.0);
        letterFrequency.put('C', 3.0);
        letterFrequency.put('D', 4.0);
        letterFrequency.put('E', 5.0);
        letterFrequency.put('F', 6.0);
        letterFrequency.put('G', 7.0);
        letterFrequency.put('H', 8.0);
        letterFrequency.put('I', 9.0);
        letterFrequency.put('J', 10.0);
        letterFrequency.put('K', 11.0);
        letterFrequency.put('L', 12.0);
        letterFrequency.put('M', 13.0);
        letterFrequency.put('N', 14.0);
        letterFrequency.put('O', 15.0);
        letterFrequency.put('P', 16.0);
        letterFrequency.put('Q', 17.0);
        letterFrequency.put('R', 18.0);
        letterFrequency.put('S', 19.0);
        letterFrequency.put('T', 20.0);
        letterFrequency.put('U', 21.0);
        letterFrequency.put('V', 22.0);
        letterFrequency.put('W', 23.0);
        letterFrequency.put('X', 24.0);
        letterFrequency.put('Y', 25.0);
        letterFrequency.put('Z', 26.0);
        delta = -1;
    }
